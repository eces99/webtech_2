        ...
        <div class="row row-cols-1 row-cols-md-2 g-4 pt-4 pb-5">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    Bitte <a href="./login_page.php">login</a> Sie sich ein, um fortzufahren. Falls Sie noch kein Konto haben, können Sie sich hier <a href="./register_page.php">registrieren</a>.
                </div>
                </div>
            </div>
            </div>
