...
<body>
    ...
    <div class="bg-image" style="background-image: url('./room_imgs/bg_rooms.jpg'); height: 100%; background-repeat: no-repeat; background-size: cover; background-position:center;">
